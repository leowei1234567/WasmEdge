...
pub mod wasmedge_hostfunctionexample {
    ...
    extern "C" {
        ...
        pub fn host_function_example_set_class_level(level: u32);
...
pub fn set_class_level(level: u32) {
    unsafe {
        wasmedge_hostfunctionexample::host_function_example_set_class_level(level);
    }
}
